Feature: Netgroup settings manipulation
    ...
    Scenario: Add host to Host category
        ...
        When I click on search link in dual list
        Then I should see "item-my-server.ipa.test" dual list item on the left

        When I click on "item-my-server.ipa.test" dual list item
        Then I should see "item-my-server.ipa.test" dual list item selected

        When I click on the "dual-list-add-selected" button
        Then I should see "item-my-server.ipa.test" dual list item on the right
        And I should see "item-my-server.ipa.test" dual list item not selected

        When I click on the "modal-button-add" button
        Then I should not see "dual-list-modal" modal
        And I should see "add-member-success" alert
        And I should see "my-server.ipa.test" entry in the data table
    ...
    Scenario: Remove host from Host category
        ...
        Then I should see "my-server.ipa.test" entry in the data table
        When I select entry "my-server.ipa.test" in the settings data table "host"
        Then I should see "my-server.ipa.test" entry selected in the data table
        ...
        Then I should not see "remove-netgroup-members-modal" modal
        And I should see "remove-netgroups-success" alert
        And I should not see "my-server.ipa.test" entry in the data table
