Feature: Automember > Settings page
    ...
    Scenario: Add a new inclusive user group rule
        ...
        And I type in the "modal-textbox-expression" textbox text "my_department"

        When I click on the "modal-button-add" button
        Then I should see "add-automember-condition-success" alert
        And I should see "my_department" entry in the data table with ID "automemberinclusiveregex-table"
    ...
    Scenario: Add a new exclusive user group rule
        ...
        And I type in the "modal-textbox-expression" textbox text "license123"
    ...
    Scenario: Add a new exclusive host group rule
        ...
        And I type in the "modal-textbox-expression" textbox text "Software engineer"
    ...
    @seed
    Scenario: Prep: Create a new host group to work with
        Given hostgroup rule "my_automember_hostgroup" exists and has "inclusive" entry "my_department" with category "businesscategory"
    ...
    Scenario: Host group rule: Delete inclusive entry from table
        ...
        When I select "my_department" entry in the data table with ID "automemberinclusiveregex-table"
        Then I should see "my_department" entry selected in the data table with ID "automemberinclusiveregex-table"
    ...
    @seed
    Scenario: Prep: Create a new user group to work with
        Given user group rule "my_automember_usergroup" exists and has "inclusive" entry "my_department" with category "businesscategory"
