...
Then(
  "I should see user group rule {string} in the user group rule list",
  (userGroupName: string) => {
...
Then(
  "I should not see user group rule {string} in the user group rule list",
  (userGroupName: string) => {
    searchForEntry(userGroupName);
    entryDoesNotExist(userGroupName);
  }
...
When("I try to delete user group {string}", (userGroupName: string) => {
  selectEntry(userGroupName);
