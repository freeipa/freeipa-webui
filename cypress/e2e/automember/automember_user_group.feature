Feature: Automember user group management
    ...
    Scenario: Create new user group rule
        ...
        Then I should see user group rule "my_automember_usergroup" in the user group rule list
    ...
    @test
    Scenario: Delete automember user group rule and user group
        Given I am logged in as admin
        And I am on "user-group-rules" page
        When I try to delete user group rule "my_automember_usergroup"
        Then I should not see user group rule "my_automember_usergroup" in the user group rule list
