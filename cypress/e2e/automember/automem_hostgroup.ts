...
import "../hostgroups/hostgroup_management";
import "../common/data_tables";
import { navigateTo } from "../common/navigation";
import { loginAsAdmin, logout } from "../common/authentication";
import { createHostgroup } from "../hostgroups/hostgroup_management";
...
Given("I set default hostgroup rule {string}", (hostgroupName: string) => {
