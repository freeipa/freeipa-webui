...
type entryType = "inclusive" | "exclusive";
...
Given(
  "hostgroup rule {string} exists and has {string} entry {string} with category {string}",
  (
...
Given(
  "user group rule {string} exists and has {string} entry {string} with category {string}",
  (
