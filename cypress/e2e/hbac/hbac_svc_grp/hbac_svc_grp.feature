Feature: HBAC service groups manipulation
  ...
  Scenario: Delete many service groups
    ...
    Then I should not see "a_service_group2" entry in the data table
    Then I should not see "a_service_group3" entry in the data table
  ...
  Scenario: Cancel creation of a service group
    ...
    Then I should not see "add-hbac-service-group-modal" modal
    Then I should not see "a_service_group_cancel" entry in the data table