Feature: DNS Servers
    ...
    Scenario: Change SOA name
        ...
        And main DNS server exists
        And I am on "dns-servers/server.ipa.demo" page
    ...
    Scenario: Set DNS server to default values
        ...
        When I change SOA name to "server.ipa.demo"
        Then I should see "server.ipa.demo" in the "dns-servers-tab-settings-textbox-idnssoamname" textbox
