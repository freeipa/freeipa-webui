...
import { clearAndAddAdjustedNumberValue } from "./dnszonesSettings";
import { createDnsZone, parseZoneName } from "./dnszones";
import { selectOption } from "../common/ui/select";

export const checkNewDnsRecord = (
...
export const addDnsRecordTypeA = (
  ipAddress: string,
...
export const addDnsRecordTypeAAAA = (
  ipAddress: string,
  createReverse: boolean
) => {
...
export const addDnsRecordTypeA6 = (recordData: string) => {
...
export const addDnsRecordTypeAFSDB = (subtype: string, hostname: string) => {
...
// TODO: This record type won't be included in the test suite until the bug
//   preventing them to be displayed in the table is fixed
export const addDnsRecordTypeCERT = (
  type: string,
  keyTag: string,
  algorithm: string,
  certificate: string
) => {
  clearAndAddAdjustedNumberValue("modal-number-input-cert-part-type", type);
  cy.dataCy("modal-number-input-cert-part-type").should("have.value", type);
  clearAndAddAdjustedNumberValue(
    "modal-number-input-cert-part-key-tag",
    keyTag
  );
  cy.dataCy("modal-number-input-cert-part-key-tag").should(
    "have.value",
    keyTag
  );
  clearAndAddAdjustedNumberValue(
    "modal-number-input-cert-part-algorithm",
    algorithm
  );
  cy.dataCy("modal-number-input-cert-part-algorithm").should(
    "have.value",
    algorithm
  );
  cy.dataCy("modal-textarea-cert-part-certificate-or-crl").type(certificate);
  cy.dataCy("modal-textarea-cert-part-certificate-or-crl").should(
    "have.value",
    certificate
  );
...
export const addDnsRecordTypeCNAME = (hostname: string) => {
...
export const addDnsRecordTypeDNAME = (target: string) => {
...
export const addDnsRecordTypeDS = (
  keyTag: string,
  algorithm: string,
  digestType: string,
  digest: string
...
export const addDnsRecordTypeDLV = (
  keyTag: string,
  algorithm: string,
  digestType: string,
  digest: string
...
export const addDnsRecordTypeKX = (preference: string, exchanger: string) => {
  clearAndAddAdjustedNumberValue(
...
export const addDnsRecordTypeLOC = (
  latDeg: string,
  latMin: string,
  latSec: string,
  latDir: string,
...
export const addDnsRecordTypeMX = (preference: string, exchanger: string) => {
  clearAndAddAdjustedNumberValue(
...
export const addDnsRecordTypeNAPTR = (
  order: string,
  preference: string,
  flags: string,
  service: string,
...
export const addDnsRecordTypeNS = (hostname: string, skipDnsCheck: boolean) => {
...
export const addDnsRecordTypePTR = (hostname: string) => {
...
export const addDnsRecordTypeSRV = (
  priority: string,
  weight: string,
  port: string,
  target: string
...
export const addDnsRecordTypeSSHFP = (
  algorithm: string,
  fpType: string,
  fingerprint: string
) => {
...
export const addDnsRecordTypeTLSA = (
  certUsage: string,
  selector: string,
  matchingType: string,
...
export const addDnsRecordTypeTXT = (data: string) => {
...
export const addDnsRecordTypeURI = (
  priority: string,
  weight: string,
  target: string
) => {
...
export const createDnsRecord = (dnsRecordName: string, type: DnsRecordType) => {
  ...
  selectOption(type.toLowerCase(), "record-type");
  cy.get("[data-cy='record-type-toggle'] span").should("have.text", type);
  ...
  switch (type) {
    ...
    case "DS":
      ...
      checkNewDnsRecord(
        dnsRecordName,
        "DS, NS",
        "server.ipa.demo, 20326 8 2 E06D44B80B8F1D39A95C0B0D7C65D08458E880409BBC683457104237C7F53853"
      );
      break;
    case "DLV":
      addDnsRecordTypeDLV(
...
When(
  "I create a DNS record {string} with name {string}",
  (recordType: string, recordName: string) => {
    createDnsRecord(recordName, recordType as DnsRecordType);
  }
);
...
Then(
  ...
  (recordName: string, recordType: string, recordData: string) => {
    checkNewDnsRecord(recordName, recordType as DnsRecordType, recordData);
  }
);
