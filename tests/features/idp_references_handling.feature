Feature: Identity provider references manipulation
  ...
  Scenario: Add a new 'Keycloak or Red Hat SSO' identity provider reference (with no secret)
    ...
    * In the modal, I type field with ID "identity-provider-reference-name" text "idpKeycloak"
    * In the modal, I type field with ID "client-id" text "idpKeycloakClient"
    ...
    * In the modal, I type field with ID "org" text "myOrg"
    * In the modal, I type field with ID "base-url" text "myOrg.example.test"
    * In the modal, I type field with ID "scope" text "myScopeKeycloak"
    * In the modal, I type field with ID "ext-idp-uid-attr" text "exampleAttributeKeycloak"
  ...
  Scenario: Add a new 'Keycloak or Red Hat SSO' identity provider reference (with secret)
    When I click on "Add" button
    Then I see "Add Identity Provider reference" modal
    * In the modal, I type field with ID "identity-provider-reference-name" text "idpSecretKeycloak"
    * In the modal, I type field with ID "client-id" text "idpKeycloakSecretClient"
    * In the modal, I type field with ID "secret" text "mySecret"
    * In the modal, I type field with ID "verify-secret" text "mySecret"
    * in the modal dialog I check "Pre-defined IdP template" radio selector
    * I click in the "Provider type" selector field
    * I select "Keycloak or Red Hat SSO" option in the "Provider type" selector
    * In the modal, I type field with ID "org" text "mySecretOrg"
    * In the modal, I type field with ID "base-url" text "mySecretOrg.example.test"
    * In the modal, I type field with ID "scope" text "myScopeSecretKeycloak"
    * In the modal, I type field with ID "ext-idp-uid-attr" text "exampleAttributeSecretKeycloak"
    When in the modal dialog I click on "Add" button
    * I should see "success" alert with text "Identity provider successfully added"
    * I close the alert
  ...
  Scenario: Add a new Google identity provider reference
    When I click on "Add" button
    Then I see "Add Identity Provider reference" modal
    * In the modal, I type field with ID "identity-provider-reference-name" text "idpGoogle"
    * In the modal, I type field with ID "client-id" text "idpGoogleClient"
    * in the modal dialog I check "Pre-defined IdP template" radio selector
    * I click in the "Provider type" selector field
    * I select "Google" option in the "Provider type" selector
    * In the modal, I type field with ID "scope" text "myScopeGoogle"
    * In the modal, I type field with ID "ext-idp-uid-attr" text "exampleAttributeGoogle"
    When in the modal dialog I click on "Add" button
    * I should see "success" alert with text "Identity provider successfully added"
    * I close the alert
  ...
  Scenario: Add a new Github identity provider reference
    When I click on "Add" button
    Then I see "Add Identity Provider reference" modal
    * In the modal, I type field with ID "identity-provider-reference-name" text "idpGithub"
    * In the modal, I type field with ID "client-id" text "idpGithubClient"
    * in the modal dialog I check "Pre-defined IdP template" radio selector
    * I click in the "Provider type" selector field
    * I select "Github" option in the "Provider type" selector
    * In the modal, I type field with ID "scope" text "myScopeGithub"
    * In the modal, I type field with ID "ext-idp-uid-attr" text "exampleAttributeGithub"
    When in the modal dialog I click on "Add" button
    * I should see "success" alert with text "Identity provider successfully added"
    * I close the alert
  ...
  Scenario: Add a new 'Microsoft or Azure' identity provider reference
    When I click on "Add" button
    Then I see "Add Identity Provider reference" modal
    * In the modal, I type field with ID "identity-provider-reference-name" text "idpMicrosoft"
    * In the modal, I type field with ID "client-id" text "idpMicrosoftClient"
    * in the modal dialog I check "Pre-defined IdP template" radio selector
    * I click in the "Provider type" selector field
    * I select "Microsoft or Azure" option in the "Provider type" selector
    * In the modal, I type field with ID "org" text "myOrg2"
    * In the modal, I type field with ID "scope" text "myScopeMicrosoft"
    * In the modal, I type field with ID "ext-idp-uid-attr" text "exampleAttributeMicrosoft"
    When in the modal dialog I click on "Add" button
    * I should see "success" alert with text "Identity provider successfully added"
    * I close the alert
  ...
  Scenario: Add a new 'Okta' identity provider reference
    When I click on "Add" button
    Then I see "Add Identity Provider reference" modal
    * In the modal, I type field with ID "identity-provider-reference-name" text "idpOkta"
    * In the modal, I type field with ID "client-id" text "idpOktaClient"
    * in the modal dialog I check "Pre-defined IdP template" radio selector
    * I click in the "Provider type" selector field
    * I select "Okta" option in the "Provider type" selector
    * In the modal, I type field with ID "org" text "myOrg3"
    * In the modal, I type field with ID "base-url" text "myOrg3.example.test"
    * In the modal, I type field with ID "scope" text "myScopeOkta"
    * In the modal, I type field with ID "ext-idp-uid-attr" text "exampleAttributeOkta"
    When in the modal dialog I click on "Add" button
    * I should see "success" alert with text "Identity provider successfully added"
    * I close the alert
  ...
  Scenario: Add a new Custom identity provider reference
    ...
    When I click on "Add" button
    Then I see "Add Identity Provider reference" modal
    * In the modal, I type field with ID "identity-provider-reference-name" text "idpCustom"
    * In the modal, I type field with ID "client-id" text "idpCustomClient"
    * in the modal dialog I check "Custom IdP definition" radio selector
    * In the modal, I type field with ID "auth-uri" text "https://myUri.example.test"
    * In the modal, I type field with ID "dev-auth-uri" text "https://myAuthDev.example.test"
    * In the modal, I type field with ID "token-uri" text "https://myToken.example.test"
    * In the modal, I type field with ID "user-info-uri" text "https://myUserInfo.example.test"
    * In the modal, I type field with ID "jwks-uri" text "https://myJwks.example.test"
    * In the modal, I type field with ID "scope" text "myCustomScope"
    * In the modal, I type field with ID "ext-idp-uid-attr" text "exampleAttributeCustom"
    When in the modal dialog I click on "Add" button
    * I should see "success" alert with text "Identity provider successfully added"
    * I close the alert
