Feature: Identity Providers references - Settings page
  ...
  Scenario: Check fields are reverted
    ...
    * I close the alert
    Then I should see input field with ID "ipaidpclientid" and value "idpKeycloakClient"
    Then I should see input field with ID "ipaidpscope" and value "myScopeKeycloak"
    Then I should see input field with ID "ipaidpsub" and value "exampleAttributeKeycloak"
  ...
  Scenario: Reset IdP password via kebab menu
    ...
    * In the modal, I type field with ID "modal-form-reset-password-new-password" text "myNewPassword"
    * In the modal, I type field with ID "modal-form-reset-password-verify-password" text "myNewPassword"
