          ...
          if (selectedUsersCount > 0) {
            ...
            if (selectedUsersIds[i] === state.usersList[j].uid) {
              ...
              const updatedUser = {
                ...
                krbprincipalexpiration: state.usersList[j].krbprincipalexpiration,
                ...
                ipatokenradiusconfiglink: state.usersList[j].ipatokenradiusconfiglink,
                ipatokenradiususername: state.usersList[j].ipatokenradiususername,
                ...
                krbpwdfailurecountinterval: state.usersList[j].krbpwdfailurecountinterval,
                ...
                facsimiletelephonenumber: state.usersList[j].facsimiletelephonenumber,
                // mailing
                ...
                ipanthomedirectorydrive: state.usersList[j].ipanthomedirectorydrive,
                // 'Member of' data
                ...
                ipantsecurityidentifier: state.usersList[j].ipantsecurityidentifier,
...
export const { updateUsersList, addUser, removeUser, changeStatus } = activeUsersSlice.actions;
