...
// RPC
import { ErrorResult, useChangePasswordMutation } from "src/services/rpc";
// Hooks
...
const ResetPassword = (props: PropsToResetPassword) => {
  ...
  // Verify password
  const [verifyPasswordValidation, setVerifyPasswordValidation] =
    React.useState({
      isError: false,
      message: "",
  ...
  const onResetPassword = () => {
    ...
    if (props.uid === undefined) {
      ...
      const payload = [props.uid, newPassword];
