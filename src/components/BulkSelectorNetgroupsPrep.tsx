...
interface GroupsData {
  ...
  updateSelectedGroups: (group: Netgroup[], isSelected: boolean) => void;
}
...
const BulkSelectorNetgroupsPrep = (props: PropsToBulkSelectorPrep) => {
  ...
  const selectableElementsPage = props.shownElementsList.filter(
    props.elementData.isNetgroupSelectable
  );
...
export default BulkSelectorNetgroupsPrep;
