    ...
    <Flex direction={{ default: "column", md: "row" }}>
      <FlexItem flex={{ default: "flex_1" }}>
        <Form className="pf-v5-u-mb-lg">
          <FormGroup label="Mail address" role="group">
            <IpaTextboxList
              ipaObject={ipaObject}
          ...
          <FormGroup label="Telephone number" role="group">
            <IpaTextboxList
              ipaObject={ipaObject}
              setIpaObject={recordOnChange}
          ...
          <FormGroup label="Pager number" role="group">
            <IpaTextboxList
              ipaObject={ipaObject}
              setIpaObject={recordOnChange}
              name={"pager"}
      ...
      <FlexItem flex={{ default: "flex_1" }}>
        <Form className="pf-v5-u-mb-lg">
          <FormGroup label="Mobile phone number" role="group">
            <IpaTextboxList
              ipaObject={ipaObject}
              setIpaObject={recordOnChange}
              name={"mobile"}
