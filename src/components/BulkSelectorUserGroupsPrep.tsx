...
interface GroupsData {
  ...
  updateSelectedGroups: (group: UserGroup[], isSelected: boolean) => void;
}
...
const BulkSelectorUserGroupsPrep = (props: PropsToBulkSelectorPrep) => {
  ...
  const selectableElementsPage = props.shownElementsList.filter(
    props.elementData.isUserGroupSelectable
  );
  ...
  const selectAllElementsPage = (
    isSelecting = true,
    selectableGroupsList: UserGroup[]
  ) => {
...
export default BulkSelectorUserGroupsPrep;
