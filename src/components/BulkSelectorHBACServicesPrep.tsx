...
interface ServicesData {
  ...
  isHbacServiceSelectable: (rule: HBACService) => boolean;
  updateSelectedServices: (rule: HBACService[], isSelected: boolean) => void;
}
...
const BulkSelectorHBACServicesPrep = (props: PropsToBulkSelectorPrep) => {
  ...
  const selectAllElementsPage = (
    isSelecting = true,
    selectableServicesList: HBACService[]
  ) => {
...
export default BulkSelectorHBACServicesPrep;
