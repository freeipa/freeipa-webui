...
const PasswordPolicySettings = (props: PropsToPwPolicySettings) => {
  ...
  const onSave = () => {
    ...
    const payload: PwPolicyModPayload = {
      pwPolicyId: props.pwPolicy.cn?.toString() as string,
    };

    if (modifiedValues.krbmaxpwdlife) {
      payload.krbmaxpwdlife =
        modifiedValues.krbmaxpwdlife?.toString() as string;
    }
    if (modifiedValues.krbminpwdlife) {
      payload.krbminpwdlife =
        modifiedValues.krbminpwdlife?.toString() as string;
    }
    if (modifiedValues.krbpwdhistorylength) {
      payload.krbpwdhistorylength =
        modifiedValues.krbpwdhistorylength?.toString() as string;
    }
    if (modifiedValues.krbpwdmindiffchars) {
      payload.krbpwdmindiffchars =
        modifiedValues.krbpwdmindiffchars?.toString() as string;
    }
    if (modifiedValues.krbpwdminlength) {
      payload.krbpwdminlength =
        modifiedValues.krbpwdminlength?.toString() as string;
    }
    if (modifiedValues.krbpwdmaxfailure) {
      payload.krbpwdmaxfailure =
        modifiedValues.krbpwdmaxfailure?.toString() as string;
    }
    if (modifiedValues.krbpwdfailurecountinterval) {
      payload.krbpwdfailurecountinterval =
        modifiedValues.krbpwdfailurecountinterval?.toString() as string;
    }
    if (modifiedValues.krbpwdlockoutduration) {
      payload.krbpwdlockoutduration =
        modifiedValues.krbpwdlockoutduration?.toString() as string;
    }
    if (modifiedValues.cospriority) {
      payload.cospriority = modifiedValues.cospriority?.toString() as string;
    }
    if (modifiedValues.passwordgracelimit) {
      payload.passwordgracelimit =
        modifiedValues.passwordgracelimit?.toString() as string;
    }
