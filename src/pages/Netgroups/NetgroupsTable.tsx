...
interface GroupsData {
  ...
  selectableGroupsTable: Netgroup[];
  setGroupSelected: (group: Netgroup, isSelecting?: boolean) => void;
...
export interface PropsToTable {
  elementsList: Netgroup[];
  shownElementsList: Netgroup[];
...
const NetgroupsTable = (props: PropsToTable) => {
  ...
  const isGroupSelected = (group: Netgroup) => {
    if (
