...
import { useFindAvailablePrivilegesQuery } from "src/services/rpcPrivileges";
// Utils
...
const PrivilegesAddModal = (props: PrivilegesAddModalProps) => {
  ...
  const privilegesQuery = useFindAvailablePrivilegesQuery(adderSearchValue, {
...
const PermissionsPrivileges = (props: PropsToPermissionsPrivileges) => {
  ...
  const selectablePrivilegesTable = privileges;
