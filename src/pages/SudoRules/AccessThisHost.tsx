      ...
      if ("data" in response) {
        ...
        results.forEach((result) => {
          ...
          if (result.error !== null) {
            dispatch(
              addAlert({
                name: "access-this-host-add-host-external-error",
            ...
            if (
              ...
              dispatch(
                addAlert({
                  name: "access-this-host-add-host-external-success",
      ...
      if ("data" in response) {
        ...
        if (results) {
          ...
          if (
            ...
            dispatch(
              addAlert({
                name: "access-this-host-remove-host-external-success",
          ...
          // Check if any errors
            ...
            dispatch(
              addAlert({
                name: "access-this-host-remove-host-external-error",
      ...
      if ("data" in response) {
        ...
        results.forEach((result) => {
          ...
          if (containsAny(hostGroupsFromResponse, newHostGroups)) {
            ...
            dispatch(
              addAlert({
                name: "access-this-host-add-hostgroup-external-success",
                title: "Added new item(s) to '" + props.rule.cn + "'",
                variant: "success",
              })
            );
          ...
          if (result.error !== null) {
            dispatch(
              addAlert({
                name: "access-this-host-add-hostgroup-external-error",
                title: "Error: " + result.error,
                variant: "danger",
              })
            );
      ...
      if ("data" in response) {
        ...
        if (results) {
          ...
          if (!containsAny(groupsFromResponse, hostGroupsToDelete)) {
            ...
            dispatch(
              addAlert({
                name: "access-this-host-remove-hostgroup-external-success",
                title: "Removed item(s) from " + props.rule.cn,
                variant: "success",
              })
            );
          ...
          // Check if any errors
            ...
            dispatch(
              addAlert({
                name: "access-this-host-remove-hostgroup-external-error",
                title: "Error: " + results.error,
                variant: "danger",
              })
            );
